...
static void PlayerInUncoveredHugeSeg(Game_data* const);
...
static void AddLastingEffect(Lasting_effect* const , const Lasting_effect, const int);
static void RemoveLastingEffect(Lasting_effect* const, const int, const int);
