...
void MoveStrikingBeing(Being* const, float const, float const, float const);
void UpdateBeingStrike(Being* const, Player* const, float const, float const, float const);
void UpdateBeingFollow(Being* const, float const, float const, float const);
